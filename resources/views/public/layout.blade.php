...
<head>
    ...
    <title>@yield('title') - Yayasan Alza el Rohmah</title>
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="{{ route('public.home') }}">Yayasan Alza el Rohmah</a>
    ...
    <footer class="bg-primary text-white text-center py-3">
        <small>&copy; {{ date('Y') }} Yayasan Alza el Rohmah. All rights reserved.</small>
    </footer>
</body>
