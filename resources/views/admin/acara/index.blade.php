                                ...
                                <tr class="donation-item">
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <div class="bg-light p-2 rounded text-center">
                                                ...
                                                <p class="small text-muted mb-0">Tidak ada</p>
                                            </div>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('admin.acara.show', $item->id) }}" class="btn btn-info action-btn"
                                                title="Lihat Detail">
                                            ...
                                            <form action="{{ route('admin.acara.destroy', $item->id) }}" method="POST"
                                                class="d-inline" onsubmit="return confirm('Hapus acara ini?')">
                                                @csrf
                                                @method('DELETE')
